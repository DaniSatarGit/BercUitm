...
$query = "SELECT * FROM berc5_draftt WHERE user_id = ?";
...
if ($_SERVER['REQUEST_METHOD'] === 'POST' && (isset($_POST['save_draft']) || isset($_POST['next']))) {
    ...
    if (isset($_POST['save_draft'])|| isset($_POST['next'])) {
        ...
        if ($draft) {
            ...
            // Masukkan draf baru
            $query = "INSERT INTO berc5_draftt (user_id, fberc1_berc5, fberc2_berc5, fberc3_berc5, fberc4_berc5, fberc5_berc5, form_signed_berc5, approved_by_faculty_berc5, supervisor_checked_berc5, additional_comments_berc5, decision_berc5, applicant_signature_berc5, applicant_date_berc5, supervisor_signature_berc5, supervisor_date_berc5, submission_date_berc5) VALUES (?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, NOW())";
            $stmt = $conn->prepare($query);
        ...
        // Redirect ke berc5db.php untuk menghantar form
...
<body>
    <nav>
        <ul>
            ...
            <li><a href="Berc4.php">BERC4</a></li>
    ...
    <tr>
        <td>
            ...
            <p style="margin: 0; line-height: 1.5; text-indent: 15px;"><i>Adakah anda telah melengkapkan borang F/BERC 5?</i></td>
        <td>
        ...
        <td>
            <input type="radio" name="fberc5_berc5" value="No" style="margin-left: 20px;" <?php echo (isset($_SESSION['fberc5_berc5']) && $_SESSION['fberc5_berc5'] == 'No') ? 'checked' : ''; ?>>
        </td>
    </tr>
    <tr>
        <td>
            <p style="margin: 0; line-height: 1.8; text-indent: 0px;">6. Has the form been signed by all researchers?</p>
    ...
    <tr>
        <td>
            <p style="margin: 0; line-height: 1.8; text-indent: 0px;">7. Has your application been approved and endorsement by your Faculty/State Research Committee?</p>
            <p style="margin: 0; line-height: 1.5; text-indent: 15px;"><i>Sudahkah permohonan anda mendapat kelulusan dan pengesahan Jawatankuasa Penyelidikan Fakulti/Negeri?</i></p>
        </td>
        <td>
    ...
    <tr>
        <td>
            ...
            <p style="margin: 0; line-height: 1.5; text-indent: 15px;"><i>Adakah penyelia anda telah menyemak untuk kesalahan tatabahasa dalam borang REC 2 dan borang REC 4?</i></p>
        </td>
        <td>
        ...
        <label><input type="radio" name="decision_berc5" value="not-approved" <?php echo (isset($_SESSION['decision_berc5']) && $_SESSION['decision_berc5'] == 'not-approved') ? 'checked' : ''; ?>> Not approved due to unresolved ethical issues. Recommend to resubmit.<br> Tidak lulus disebabkan isu etika. Dicadangkan untuk memohon semula.</i></label>
    </div>
    <br>
    ...
    <table>
        <tbody>
            ...
            <div class="button-container">
                <!-- Back button -->
                <button class="back-button" type="button" onclick="location.href='berc4.php'">Back</button>
