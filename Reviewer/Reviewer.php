...
<body>
    ...
    <header class="main-header d-flex justify-content-between align-items-center px-4 py-3 shadow-sm">
        ...
        <div class="header-center">
            <h1 class="h5">Reviewer Dashboard</h1>
        </div>
            ...
            <div class="col-md-5 mb-4">
                <div class="card custom-card text-center">
                    <div class="card-body">
                        ...
                        <p class="card-text">Review the applications assigned to you.</p>
                        <a href="application_reviewer.php" class="btn btn-primary mt-3">Go to Application</a>
                    </div>
                </div>
            </div>

            <!-- Exemption Portal Card -->
            <div class="col-md-5 mb-4">
                <div class="card custom-card text-center">
                    <div class="card-body">
                        <h5 class="card-title">Exemption Portal</h5>
                        <p class="card-text">Manage exemptions and track requests.</p>
