            ...
            <div class="col-md-5 mb-4">
                <div class="card custom-card text-center">
                    <div class="card-body">
                        ...
                        <a href="Application/application.php" class="btn btn-primary mt-3">Go to Application</a>
                    </div>
                </div>
            </div>
            ...
            <div class="col-md-5 mb-4">
                <div class="card custom-card text-center">
                    <div class="card-body">
                        ...
                        <a href="Exemption/exemption.php" class="btn btn-primary mt-3">Go to Exemption</a>
                    </div>
                </div>
            </div>
        </div>
